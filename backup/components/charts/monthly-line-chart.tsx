...
import { ProgressiveLoader, loadingStages } from '@/components/ui/progressive-loader';
...
export function MonthlyLineChart({ 
    ...
    const { data, error, refetch, currentStage } = useMonthlyChartDataSimple(startDate, endDate);
    ...
    // Handle loading state with progressive loader
    if (isLoading) {
        return (
            <Card className={`${className} overflow-hidden border-0 bg-transparent shadow-none`}>
                ...
                <CardContent className="px-4 pt-0 pb-1">
                    <ProgressiveLoader
                        isLoading={true}
                        stages={loadingStages.monthlyData}
