...
interface MonthlyBranchSummaryAccordionProps {
    startDate: string;
    endDate: string;
    className?: string;
...
export function MonthlyBranchSummaryAccordion({ startDate, endDate, className, onBranchDetailsClick }: MonthlyBranchSummaryAccordionProps) {
